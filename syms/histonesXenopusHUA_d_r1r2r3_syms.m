function [model] = histonesXenopusHUA_d_r1r2r3_syms()
...
syms 'noise' 'r1_h' 'r2_h' 'r3_h' 'd_h' 
% create parameter vector
model.sym.p = [noise r1_h r2_h r3_h d_h ];
...
model.sym.xdot(1) = -r1_h*K20P+d_h*K20m1;
model.sym.xdot(2) = r1_h*K20P-(r2_h+d_h)*K20m1+d_h*K20m2;
model.sym.xdot(3) = r2_h*K20m1-(r3_h+d_h)*K20m2+d_h*K20m3;
model.sym.xdot(4) = r3_h*K20m2-d_h*K20m3;
