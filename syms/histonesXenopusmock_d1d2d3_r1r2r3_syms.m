function [model] = histonesXenopusmock_d1d2d3_r1r2r3_syms()
...
syms 'c' 'K20m1_0' 'K20m2_0' 'K20m3_0' 'noise' 'd1_m' 'd2_m' 'd3_m' 'r1_m' 'r2_m' 'r3_m' 
% create parameter vector
model.sym.p = [c K20m1_0 K20m2_0 K20m3_0 noise d1_m d2_m d3_m r1_m r2_m r3_m];
...
model.sym.xdot(1) = -r1_m*K20P+(d1_m+(log(2)/c))*K20m1+(log(2)/c)*K20m2+(log(2)/c)*K20m3;
model.sym.xdot(2) = r1_m*K20P-(r2_m+d1_m+(log(2)/c))*K20m1+d2_m*K20m2;
model.sym.xdot(3) = r2_m*K20m1-(r3_m+d2_m+(log(2)/c))*K20m2+d3_m*K20m3;
model.sym.xdot(4) = r3_m*K20m2-(d3_m+(log(2)/c))*K20m3;
