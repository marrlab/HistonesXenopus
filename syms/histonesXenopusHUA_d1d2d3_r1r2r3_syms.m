function [model] = histonesXenopusHUA_d1d2d3_r1r2r3_syms()
...
syms 'K20m1_0' 'K20m2_0' 'K20m3_0' 'noise' 'd1_h' 'd2_h' 'd3_h' 'r1_h' 'r2_h' 'r3_h' 
% create parameter vector
model.sym.p = [K20m1_0 K20m2_0 K20m3_0 noise d1_h d2_h d3_h r1_h r2_h r3_h];
...
model.sym.xdot(1) = -r1_h*K20P+d1_h*K20m1;
model.sym.xdot(2) = r1_h*K20P-(r2_h+d1_h)*K20m1+d2_h*K20m2;
model.sym.xdot(3) = r2_h*K20m1-(r3_h+d2_h)*K20m2+d3_h*K20m3;
model.sym.xdot(4) = r3_h*K20m2-d3_h*K20m3;
