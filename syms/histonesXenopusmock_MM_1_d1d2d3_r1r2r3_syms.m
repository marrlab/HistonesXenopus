function [model] = histonesXenopusmock_MM_1_d1d2d3_r1r2r3_syms()
...
syms 'b' 'K20m1_0' 'K20m2_0' 'K20m3_0' 'noise' 'd1_m' 'd2_m' 'd3_m' 'r1_m' 'r2_m' 'r3_m'  
% create parameter vector
model.sym.p = [b K20m1_0 K20m2_0 K20m3_0 noise d1_m d2_m d3_m r1_m r2_m r3_m];
...
model.sym.xdot(1) = -r1_m*K20P+d1_m*K20m1+log(2)/(0.5+(b*t)/(b+t))...
