function [model] = histonesXenopusmock_lin_r1r2r3_syms()
...
syms 'd' 'K20m1_0' 'K20m2_0' 'K20m3_0' 'noise' 'r1_m' 'r2_m' 'r3_m' 
% create parameter vector
model.sym.p = [d K20m1_0 K20m2_0 K20m3_0 noise r1_m r2_m r3_m];
...
model.sym.xdot(1) = -r1_m*K20P+(log(2)/(0.5+(d*t)))...
